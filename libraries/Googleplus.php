...
class Googleplus
{
    ...
    public function __construct()
    {
        ...
        require FCPATH . 'crud/third_party/google-api-php-client/src/Google_Client.php';
        require FCPATH . 'crud/third_party/google-api-php-client/src/contrib/Google_PlusService.php';
